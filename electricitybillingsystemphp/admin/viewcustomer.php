...
<div>
				...
				<div class="container">
				    <div class=row>
				        <div class="col-sm-12">
  <h1 class = text-center style = "font-family : 'Monotype Corsiva' ; color : purple"><b>All Customers</b></h1>
...
echo "<td>$column[6]</td>";	
echo "<td>$column[7]</td>";																				
echo '<td><a class = "btn btn-xs btn-warning" href="deletecustomer.php?id='.$column['customerid'].'">
													Remove
													</a></td>';
