...
<div>
				...
				<div class="container">
				    <div class=row>
				        <div class="col-sm-12">
  <h1 class = text-center style = "font-family : 'Monotype Corsiva' ; color : purple"><b>View All Connections</b></h1>
...
echo "<th>Connection StartDate</th>";
...
echo '<td><a class = "btn btn-xs btn-warning" href="deleteconnection.php?id='.$column['connectionid'].'">
													Remove
													</a></td>';
