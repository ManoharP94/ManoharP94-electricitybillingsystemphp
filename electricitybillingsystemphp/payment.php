            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    <form method="POST">
						...
						<input type="hidden" name = "customername" id = "customername" class="form-control" value = "<?php echo @$_POST['customername']; ?>">
						<input type="hidden" name="emailid" id="emailid" class="form-control" value = "<?php echo @$_POST['emailid']; ?>">
						<input type="hidden" name="contactno" id="contact" class="form-control" value = "<?php echo @$_POST['contactno']; ?>">
						...
						<input type="hidden" name="sprice" id="sprice" class="form-control" value = "<?php echo @$_POST['sprice'] ?>">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $_GET['total'] ?>" name="amount" readonly/>
                                </div>
                            </div>                        
                        </div>
                        <div class="row">
